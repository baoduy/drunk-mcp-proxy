...
- Proxy docs already describe `skill_dir` behavior and directory layout in `../../drunk_ai_proxy/features/mcp/proxy-management.md`.
...
- Add usage doc under `../../drunk_ai_proxy/features/mcp/` for:
...
- `../../drunk_ai_proxy/features/mcp/proxy-management.md`
