...
**Tests**: The examples below include test tasks. Tests are REQUIRED for behavior changes and MAY be omitted only for explicitly non-runtime documentation-only work.
...
- [ ] T010 Add constitution compliance tasks (security review, changelog update, test evidence capture)
...
- [ ] TXXX Update CHANGE_LOGS.md under Unreleased
...
- Tests MUST be written and FAIL before implementation for behavior-changing work
