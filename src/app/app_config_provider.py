...
class AppConfigProvider:
    ...
    def get_auth_config(self, provider_name:AuthType | None=None) ->tuple[str, dict[str, Any]|None]:
        ...
        if name is None:
            raise ValueError("No provider name specified and no default provider configured")
    ...
    def get_client_auth_handler(self, provider_name:AuthType|None = None, auth_passthrough:bool=False) -> "Auth | None":
