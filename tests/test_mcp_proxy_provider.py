...
class TestMcpProxyProviderCreateSkillProxy:
    ...
    def test_create_skill_proxy_with_valid_subdirectories(self, mock_skills_provider_cls, mock_path_cls):
    ...
    @patch('pathlib.Path')
    @patch('fastmcp.server.providers.skills.SkillsDirectoryProvider')
    def test_create_skill_proxy_subdirectories_sorted(self, mock_skills_provider_cls, mock_path_cls):
    ...
    @patch('pathlib.Path')
    @patch('fastmcp.server.providers.skills.SkillsDirectoryProvider')
    def test_create_skill_proxy_ignores_files(self, mock_skills_provider_cls, mock_path_cls):
        ...
        mock_path_instance = MagicMock()
        mock_path_instance.exists.return_value = True
        mock_path_instance.iterdir.return_value = [mock_skill1, mock_file, mock_skill2, mock_hidden]
        mock_path_cls.return_value = mock_path_instance
