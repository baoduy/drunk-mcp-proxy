...
from drunk_ai_proxy.auth.auth_pass_through import AuthPassThrough


class TestAuthPassThroughGetToken:
    """Test suite for AuthPassThrough._get_token method."""

    @patch('drunk_ai_proxy.auth.auth_pass_through.get_access_token')
    ...
    @patch('drunk_ai_proxy.auth.auth_pass_through.logger')
    @patch('drunk_ai_proxy.auth.auth_pass_through.get_access_token')
